...
<html lang="es">
    ...
    <body>
        <main class="panel">
            ...
            <p class="description">Este espacio necesita permisos adicionales para tu cuenta actual.</p>

            <div class="actions">
                <a href="/" class="btn">Volver al portal</a>
                <a href="/backoffice" class="btn">Probar de nuevo</a>
